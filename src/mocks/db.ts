...
export let mockEvents: Event[] = [
  ...
  },
  {
    ...
    price: 49900,
    currency: 'EUR',
    image_url: '/img/partners/cloudevents-logo.png',
    banner_url: '',
  ...
  },
  {
    ...
    price: 7500,
    currency: 'EUR',
    image_url: '/img/brand/logo-main-full.png',
    banner_url: '',
    tags: ['DFIR', 'Forense', 'Respuesta a Incidentes', 'Sevilla', 'Taller'],
    language: 'Español',
    organization: org3,
    organization_id: org3.id,
    organization_name: org3.name,
    status: 'published',
    is_public: true,
    is_featured: false,
    is_upcoming: true,
...
export let mockUsers: User[] = [
  ...
  },
  {
    ...
    created_at: new Date().toISOString(),
    favorite_events: [mockEvents[0] as any, mockEvents[2] as any],
    FavoriteEvents: [mockEvents[0] as any, mockEvents[2] as any],
