    ...
    >
      ...
      <Box sx={{ flex: 1, textAlign: { xs: 'center', md: 'left' } }}>
        ...
        >
          ...
          {sanitizeUrl(organization.website) && (
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
        ...
        <Stack
          ...
          sx={{ gap: 1 }}
        >
          {sanitizeUrl(socialLinks?.twitter) && (
            <IconButton
              href={sanitizeUrl(socialLinks!.twitter) as string}
              target='_blank'
              size='small'
              sx={{
                color: '#000000',
          ...
          {sanitizeUrl(socialLinks?.linkedin) && (
            <IconButton
              href={sanitizeUrl(socialLinks!.linkedin) as string}
              target='_blank'
              size='small'
              sx={{
                color: '#0A66C2',
          ...
          {sanitizeUrl(socialLinks?.github) && (
            <IconButton
              href={sanitizeUrl(socialLinks!.github) as string}
              target='_blank'
              size='small'
              sx={{
                color: '#333',
          ...
          {sanitizeUrl(`mailto:${organization.email}`) && organization.email && (
            <IconButton
              href={sanitizeUrl(`mailto:${organization.email}`) as string}
              size='small'
              sx={{
                color: 'var(--color-cadetblue)',
